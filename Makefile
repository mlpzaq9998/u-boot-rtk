...
ARM_SRC_ROOT := $(TOPDIR)/..
#BPI
TOOLCHAIN_PREFIX := asdk64-4.9.4-a53-EL-3.10-g2.19-a64nt-160307
...
CROSS_COMPILE = $(TOPDIR)/toolchain/gcc-linaro-7.3.1-2018.05-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-
